...
const experiences = [
  ...
  },
  {
    ...
    details: [
      ...
      'Streamlined workflows and improved team collaboration across multiple departments, including 2D artists, illustrators, UI/UX signers, and developers, by implementing specialized tools.',
      '',
      '',
    ],
  },
