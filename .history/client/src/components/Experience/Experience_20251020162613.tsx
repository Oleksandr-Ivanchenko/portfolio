...
const experiences = [
  ...
  },
  {
    ...
    details: [
      ...
      'Frontend Development: Built user interfaces for games and web apps using JavaScript, React, and CSS, collaborating closely withdesigners to create interactive and responsive UIs.',
    ],
  },
];
