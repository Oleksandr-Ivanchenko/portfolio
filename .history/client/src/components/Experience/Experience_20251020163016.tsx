...
const experiences = [
  ...
  },
  {
    ...
    details: [
      ...
      'Streamlined workflows and improved team collaboration across multiple departments, including 2D artists, illustrators, UI/UX designers, and developers, by implementing specialized tools.',
      'Supervised and coordinated efforts of QA testers, 2D artists, developers, SEO specialists, writers, and web designers to ensure quality and consistency with project goals',
    ...
    details: [
      ...
      'Improved performance by removing unnecessary dependencies and implementing features for proper icon display, screen rotation, and offline mode.',
      'Diagnosed and resolved bugs, improving functionality and stability.',
      'Integrated third-party SDKs for analytics, social sharing, and push notifications.',
      'Set up in-app purchases and ad integrations using Google AdMob and Unity Ads.',
      'Worked with studios like Gameloft to maintain high-quality standards.',
    ],
  },
];
