...
const experiences = [
  ...
  },
  {
    ...
    details: [
      ...
      'Supervised and coordinated efforts of QA testers, 2D artists, developers, SEO specialists, writers, and web designers to ensurequality and consistency with project goals',
      '',
    ],
  },
];
