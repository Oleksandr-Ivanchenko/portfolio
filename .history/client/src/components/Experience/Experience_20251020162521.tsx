...
const experiences = [
  ...
  },
  {
    ...
    details: [
      Successfully led the development of multiple games and web applications from concept to launch, maintaining high quality even
with extended timelines.
Frontend Development: Built user interfaces for games and web apps using JavaScript, React, and CSS, collaborating closely with
designers to create interactive and responsive UIs.
Streamlined workflows and improved team collaboration across multiple departments, including 2D artists, illustrators, UI/UX
designers, and developers, by implementing specialized tools.
Supervised and coordinated efforts of QA testers, 2D artists, developers, SEO specialists, writers, and web designers to ensure
quality and consistency with project goals.
