    ...
    <main className="home">
      <div className="home__container">
        ...
        <p className="home__description">
          I build resilient web systems with clean architecture, automation, and AI integration. My focus is on scalable engineering, transparent pipelines, and developer-friendly solutions.
        </p>
